...
The archived Version 1.0.0 is available at Zenodo: https://doi.org/10.5281/zenodo.22249366.
...
Fei, J. (2026). *Code for Scale-Dependent and Seasonally Modulated Spatial Propagation of Rapid-Onset, Monthly-Scale, and Seasonal-Scale Meteorological Drought across Mainland China* (Version 1.0.0) [Computer software]. Zenodo. https://doi.org/10.5281/zenodo.22249366.
